    ...
    <>
      <section id="loja" className="public-section-warm mx-auto max-w-7xl px-5 py-24 sm:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-neutral-600">Escolha seus produtos, compre com segurança e retire na barbearia ou receba conforme a disponibilidade.</p>
        </div>
