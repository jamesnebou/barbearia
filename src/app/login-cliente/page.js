...
export const metadata = {
  title: "Login da barbearia | NexaWi Barbearias",
};
  ...
  return (
    <main className="grid min-h-screen bg-[#f7f7f4] text-neutral-950 lg:grid-cols-[1fr_520px]">
      <section className="hidden min-h-screen flex-col justify-between border-r border-neutral-200 bg-white p-10 lg:flex">
        <Link href="/" className="flex items-center gap-2 text-[#1f6dee]">
          <Sparkles size={20} />
          <span className="text-sm font-bold uppercase tracking-[0.18em]">NexaWi Barbearias</span>
        </Link>

        <div className="max-w-xl">
          <p className="text-xs font-bold uppercase tracking-[0.22em] text-[#1f6dee]">Área da barbearia</p>
          <h1 className="mt-4 text-5xl font-black tracking-tight">Entre para operar sua barbearia.</h1>
          <p className="mt-5 text-sm leading-7 text-neutral-600">
            Acesso para recepção, gestores, barbeiros e financeiro acompanharem toda a operação com a identidade da barbearia.
          </p>
          <div className="mt-8 grid gap-3">
            <div className="rounded-lg border border-neutral-200 p-4">
              <CalendarCheck className="text-[#1f6dee]" size={22} />
              <p className="mt-3 text-sm leading-6 text-neutral-600">
                Agenda, clientes, ficha do cliente, financeiro e assinatura em um só painel.
              </p>
            </div>
            <div className="rounded-lg border border-neutral-200 p-4">
              <Palette className="text-[#1f6dee]" size={22} />
              <p className="mt-3 text-sm leading-6 text-neutral-600">
                Quando a barbearia tiver logo e cores no cadastro, o dashboard assume essa identidade visual.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="flex min-h-screen items-center justify-center px-5 py-10 sm:px-8">
        <div className="w-full max-w-md">
          ...
          <div className="rounded-lg border border-neutral-200 bg-white p-6 shadow-sm sm:p-7">
            <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-orange-50 text-[#1f6dee]">
              <LockKeyhole size={21} />
            </div>
            <p className="mt-5 text-xs font-bold uppercase tracking-[0.22em] text-[#1f6dee]">Área da barbearia</p>
            <h2 className="mt-2 text-2xl font-black tracking-tight">Entrar no dashboard</h2>
            <p className="mt-3 text-sm leading-6 text-neutral-600">Use o e-mail cadastrado na equipe da sua barbearia.</p>

            <div className="mt-5 rounded-lg border border-orange-200 bg-orange-50 p-4 text-sm text-neutral-800">
              <p className="font-black text-[#1f6dee]">Quer testar antes?</p>
            ...
            <LoginForm mode="cliente" next="/dashboard" emailPlaceholder="voce@barbearia.com" submitLabel="Entrar no dashboard" />
          </div>
