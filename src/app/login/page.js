  ...
  return (
    <main className="grid min-h-screen bg-[#f7f7f4] text-neutral-950 lg:grid-cols-[minmax(0,1fr)_520px]">
      <section className="hidden min-h-screen flex-col justify-between border-r border-neutral-200 bg-[#1c1c1c] p-10 text-white lg:flex">
        <Link href="/" className="flex items-center gap-2 text-orange-300"><Sparkles size={20} /><span className="text-sm font-black uppercase tracking-[0.18em]">NexaWi Barbearias</span></Link>
        <div className="max-w-xl">
          ...
          <p className="mt-5 text-sm leading-7 text-neutral-300">Entrada exclusiva para operar planos, status de barbearias, cobrança e suporte administrativo.</p>
        ...
        <Link href="/login-cliente" className="text-sm font-semibold text-neutral-300 hover:text-white">Entrar como barbearia cliente</Link>
      </section>
      ...
      <section className="flex min-h-screen items-center justify-center px-5 py-10 sm:px-8">
        <div className="w-full max-w-md">
          ...
          <div className="rounded-lg border border-neutral-200 bg-white p-6 shadow-sm sm:p-7">
            ...
            <LoginForm mode="gerente" next="/dashboard-admin" emailPlaceholder="admin@seudominio.com" submitLabel="Entrar no admin" />
          </div>
        </div>
      </section>
    </main>
