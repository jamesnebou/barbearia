...
export const metadata = { title: "Criar barbearia | Barbearia SaaS" };
  ...
  return (
    <main className="min-h-screen bg-[#f7f7f4] px-5 py-10 text-neutral-950">
      <section className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight">Crie a primeira barbearia</h1>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-neutral-600">
          Este fluxo substitui o bootstrap manual por SQL para novos clientes. O usuário logado será vinculado como owner da barbearia.
        </p>
