...
const WHATSAPP_URL = "https://wa.me/5577988656394?text=Ol%C3%A1%2C%20quero%20conhecer%20a%20NexaWi%20Barbearias.";
    ...
    <section id="contato" className="marketing-section px-5 py-20 sm:px-8 lg:px-10">
      <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2rem] bg-[#1c1c1c] text-white shadow-[0_34px_100px_rgba(28,28,28,0.24)] lg:grid-cols-[0.8fr_1.2fr]">
        ...
        <form onSubmit={submit} className="grid gap-4 bg-white/[0.07] p-7 backdrop-blur lg:p-10 sm:grid-cols-2">
          ...
          <label className="text-sm font-bold text-white/80">Nome da barbearia
            <input name="barbershop_name" maxLength={120} placeholder="Ex.: Barbearia Central" className="mt-2 h-12 w-full rounded-xl border border-white/12 bg-black/25 px-4 text-white outline-none placeholder:text-white/30 focus:border-orange-400" />
          </label>
          <label className="text-sm font-bold text-white/80">Quantidade de barbeiros
            <select name="barbers_count" defaultValue="2" className="mt-2 h-12 w-full rounded-xl border border-white/12 bg-[#202020] px-4 text-white outline-none focus:border-orange-400">
              <option value="1">1 barbeiro</option><option value="2">2 barbeiros</option><option value="3">3 barbeiros</option><option value="4">4 barbeiros</option><option value="5">5 ou mais</option>
            </select>
          </label>
