export function getStoreConfig(site = {}) {
  ...
  return {
    ...
    prazoEntrega: String(config.prazo_entrega || "Entrega combinada diretamente com a barbearia.").trim(),
    mensagemEntrega: String(config.mensagem_entrega || "A barbearia confirmará o envio pelo WhatsApp.").trim(),
